...
placedInfoPosition = [999.086,12004.6,0]; // позиция отрисовки посталенных и не поставленных отделений
defaultMapPos = [999.086,12174.1,0]; // стандартная позиция появления маркера ошибки на карте
markerForDirection = "no_marker"; // маркер, в направлении которого будут повёрнуты отделения
