...
_veh addItemCargoGlobal ['rhsusf_200rnd_556x45_mixed_box', 3];
...
_veh addItemCargoGlobal ['rhs_mag_m18_green', 5];

_veh addItemCargoGlobal ['rhs_weap_maaws', 1];
_veh addItemCargoGlobal ['rhs_mag_maaws_HEDP', 2];
_veh addItemCargoGlobal ['rhs_mag_maaws_HEAT', 1];

_veh addBackpackCargoGlobal ['rhsusf_assault_eagleaiii_ucp', 1];
