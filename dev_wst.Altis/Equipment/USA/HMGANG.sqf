...
_unit addVest (selectRandom ["rhsusf_spcs_ucp_rifleman", "rhsusf_spcs_ocp_rifleman"]);for '_i' from 1 to 6 do { _unit addItemToVest 'rhs_mag_30Rnd_556x45_M855A1_Stanag';};
