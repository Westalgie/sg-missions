...
_unit addPrimaryWeaponItem "hlc_mag_50rnd_556x45_M855A1_X15";

_unit forceAddUniform "FROG_USMC_KyleGloves_6_w";

_unit addVest "JCA_MCRP_V_CarrierRigKBT_01_tactical_coyote_F";
for '_i' from 1 to 4 do { _unit addItemToVest 'hlc_mag_50rnd_556x45_M855A1_X15';};
